    ...
    style={{ backgroundColor: "rgb(240, 240, 240)"}}>
      <div className="row mt-5">
        ...
        <div className="col  text-muted " >
          ...
          <br />
          <a href=""style={{textDecoration:"none"}}>PricingReference programs</a>
          <br />
          <a href=""style={{textDecoration:"none"}}>Careers</a>
          <br />
          <a href=""style={{textDecoration:"none"}}>Zerodha.tech</a>
          <br />
          <a href=""style={{textDecoration:"none"}}>Press & mediaZerodha cares (CSR)</a>
          <br />
        </div>
        <div className="col  text-muted">
          <p>Support</p>
     ...
     { /*  we have included this in an iv so that we can later stlye it properly*/}
      ...
      SCORES: Register on SCORES portal. Mandatory details for filing complaints
      on SCORES: Name, PAN, Address, Mobile Number, E-mail ID. Benefits:
      Effective Communication, Speedy redressal of the grievances </p>
      <p>Smart Online
      Dispute Resolution | Grievances Redressal Mechanism</p> 
      <p>Investments in
      securities market are subject to market risks; read all the related
      documents carefully before investing. Attention investors: 1) Stock
      brokers can accept securities as margins from clients only by way of
      pledge in the depository system w.e.f September 01, 2020. 2) Update your
      e-mail and phone number with your stock broker / depository participant
      and receive OTP directly from depository on your e-mail and/or mobile
      ...
      <p>India's
      largest broker based on networth as per NSE. NSE broker factsheet</p>
      <p> "Prevent
